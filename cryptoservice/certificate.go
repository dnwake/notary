...
func GenerateSignedCertificate(rootKey data.PrivateKey, gun string, startTime, endTime time.Time, *x509.Certificate ca) (*x509.Certificate, error) {
...
func generateCertificate(signer crypto.Signer, gun string, startTime, endTime time.Time, *x509.Certificate ca) (*x509.Certificate, error) {
